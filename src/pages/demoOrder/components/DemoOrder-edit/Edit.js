                                ...
                                <Label>
                                    ...
                                    <FormControl disabled={btnFlag == 2||false}
                                        ...
                                        ...getFieldProps('orderGoods', {
                                            ...
                                            rules: [{
                                                type:'string',required: true,pattern:/\S+/ig, message: '请输入商品名称',
                                            }],
                                        }
                                        )}
                                    />
                                ...
                                <Label>
                                    ...
                                    <FormControl disabled={btnFlag == 2||false}
                                        ...
                                        ...getFieldProps('remark', {
                                            ...
                                            initialValue: remark || '',
                                            rules: [{
                                                type:'string',required: true,pattern:/\S+/ig, message: '请输入备注信息',
                                            }],
                                        }
                                        )}
                                    />
                                ...
                                <Label>
                                    ...
                                    <FormControl disabled={btnFlag == 2||false}
                                        ...
                                        ...getFieldProps('orderName', {
                                            ...
                                            rules: [{
                                                type:'string',required: true,pattern:/\S+/ig, message: '请输入订单名称',
                                            }],
                                        }
                                        )}
                                    />
